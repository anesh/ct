...
def main(ip,ctrel_code,pci,sitename,sbu,support_team,siteid,sitetype,address,city,postalcode,province):
    ...
    swis.update(uri + '/CustomProperties', Comments='')
    swis.update(uri + '/CustomProperties', CTREL_Code=ctrel_code)
    swis.update(uri + '/CustomProperties', PCI=pci)
    swis.update(uri + '/CustomProperties', Postal_Code=postalcode)
    ...
    swis.update(uri + '/CustomProperties', Site_ID=siteid)
    swis.update(uri + '/CustomProperties', Site_Name=sitename)
    swis.update(uri + '/CustomProperties', Site_Type=sitetype)
    swis.update(uri + '/CustomProperties', Street_Address=address)
    swis.update(uri + '/CustomProperties', Support_Team=support_team)
...
if __name__ == '__main__':
    main(ip,ctrel_code,pci,sitename,sbu,support_team,siteid,sitetype,address,city,postalcode,province)
